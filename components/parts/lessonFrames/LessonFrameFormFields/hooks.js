...
import { LESSON_FRAME_REPEAT_OPTIONS } from '@/components/parts/lessonFrames/LessonFrameRepeatTypeSelectField'
...
export function valuesToLessonFrame ({ repeat, tags, dayCount, startTime, finishTime }) {
