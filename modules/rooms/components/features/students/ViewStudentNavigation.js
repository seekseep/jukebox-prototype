...
import { useGetStudentPath, useGetRoomPath } from '@rooms/hooks/router'

import { useStudentQuery } from '@rooms/hooks/students'
...
export default function ViewStudentNavigation () {
  ...
  const { data: student } = useStudentQuery(roomId, studentId)
  ...
  return (
    <>
      ...
      <TabNavigation>
        ...
        <Tab href={getStudentPath('/calendar')}>カレンダー</Tab>
